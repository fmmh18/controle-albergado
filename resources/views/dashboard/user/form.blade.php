...
@section('content')
@include('layouts.shared/page-title', ['sub_title' => 'Usuário', 'page_title' =>  \Config::get('layout.titulo')   ])
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                @if (isset($data))
                {!! Form::model($data, ['method' => 'put', 'autocomplete' => false, 'route' => ['dashboard.user.update', $data->id, http_build_query(Request::input())], 'class' => $errors->any() ? 'was-validated' : '', 'novalidate', "files" => true]) !!}
                @else
                {!! Form::open(['method' => 'post', 'autocomplete' => false, 'route' => ['dashboard.user.create', http_build_query(Request::input())], 'class' => $errors->any() ? 'was-validated' : '', 'novalidate', "files" => true]) !!}
                @endif
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-12">{!! Form::select('status', $allStatus, null, [  'class' => 'form-control' ,'placeholder' => 'Selecione uma opção']) !!}
