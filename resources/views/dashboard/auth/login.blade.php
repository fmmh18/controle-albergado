                            ...
                            <div class="col-12">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="p-4 my-auto">
                                        ...
                                        <!-- form -->
                                        {!!Form::open(['method' => 'post', 'autocomplete' => 'off', 'route' => ['auth', http_build_query(Request::input())], 'class' => ($errors->any()) ? 'was-validated': '' ,'novalidate form-horizontal mt-3'])!!}
                                            @if (sizeof($errors) > 0)
                                            ...
                                            <div class="mb-3">
                                                <a href="auth-forgotpw.html" class="text-muted float-end"><small>Esqueci minha senha?</small></a>
                                            ...
                                            <div class="mb-0 text-start">
                                                <button class="btn btn-soft-primary w-100" type="submit"><i class="ri-login-circle-fill me-1"></i> <span class="fw-bold">Acessar</span> </button>
                                            </div>
                                            {!! Form::close() !!}
                                        <!-- end form-->
                                    </div>
